...
from .views import (
    ...
    ManageOfferListView, ManageOfferDetailView, ManageOfferDetailJsonView, ManageOfferCreateView, ManageOfferDeleteView, ManageOfferUpdateView
)
...
urlpatterns = [
    ...
    path("manage/<uuid:offer_id>/", ManageOfferDetailView.as_view(), name="manage_detail"),
    path("json/<uuid:offer_id>/", ManageOfferDetailJsonView.as_view(), name="manage_detail_json"),

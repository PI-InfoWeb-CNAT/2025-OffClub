...
class Offer(models.Model):
    ...
    image = models.ImageField(
        "Imagem", upload_to="uploads/offers/", null=True, blank=True
    )
    ...
    redemption_period = models.DurationField(
        "Período de Resgate", default=timedelta(days=30)
    )
    max_coupons = models.IntegerField(
        "Quantidade máxima", default=1, validators=[MinValueValidator(1)]
    )
        ...
        return {
            ...
            "enterprise": {
                ...
                "logo_url": (
                    ...
                    if self.enterprise.user.profile_picture
                    else None
                ),
            },
            "category": {

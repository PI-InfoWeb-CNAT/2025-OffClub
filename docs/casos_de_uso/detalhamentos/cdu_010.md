...
| 28/09/2025 | 2.0 | Revisão do resumo e atualização do código do caso de uso | Heitor Barboza |
| 02/11/2025 | 3.0 | Correção de datas | Heitor Barboza |
| 18/01/2026 | 3.0 | Remoção de pontos inutilizados | Heitor Barboza |

## 1. Resumo

O usuário assinante gera cupons a partir de serviços disponibilizados para o seu plano de assinatura. 

...
| :--: | :----: | :-------: | :---: |
| 29/09/2025 | 1.0 | Versão inicial | Clara Teodósio |
| 02/11/2025 | 2.0 | Correção de datas e adequação de nome | Heitor Barboza |
...
### Tela de avaliar cupom

![Tela de avaliar cupom](imagens_detalhamentos/interfaces/avaliar_cupom.png)